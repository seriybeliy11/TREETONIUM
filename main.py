...
# Определяем имя файла для сохранения адресов
ADDRESS_FILE = "connected_addresses.txt"

# Функция для записи адреса в файл
async def write_address_to_file(address: str):
    ...
    for i in range(1, 180):
        ...
        if connector.connected:
            if connector.account.address:
                ...
                await write_address_to_file(wallet_address)
